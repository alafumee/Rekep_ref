...
def patch_match(
    ...
    print(src_ft.shape,end="  src_ft shape\n")
    print(y,end="  y\n")
    print(x,end="  x\n")
    print(half_patch_size,end="  half_patch_size\n")
    ...
    for angle in range(0, 360, 90):
        ...
        print(rotated_patch.shape,end="  rotated_patch shape\n")
    ...
    for i in range(1, num_imgs):
        ...
        for src_rotated_patch in src_rotated_patches:
            ...
            print(unfolded.shape,end="  unfolded shape\n")
            print(src_rotated_patch.shape,end="  src_rotated_patch shape\n")
